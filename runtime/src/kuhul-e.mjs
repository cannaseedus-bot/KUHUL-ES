// runtime/src/kuhul-e.mjs
//
// ES module version of KUHUL-E domain-specific response generation engine.

'use strict';

import { DomainStack } from './domain-stack.mjs';
import { ResponsePatternEngine } from './response-pattern.mjs';
